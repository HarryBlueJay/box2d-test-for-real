...
public:
    ...
    /// code (called the codepoint) in the playerSize encoding, UTF-8.
    ///
...
public:
    ...
    ///
    /// Encoding a character means converting a unique 32-bits
    /// code (called the codepoint) in the playerSize encoding, UTF-16.
    ///
...
public:
    ...
    ///
    /// Encoding a character means converting a unique 32-bits
    /// code (called the codepoint) in the playerSize encoding, UTF-32.
