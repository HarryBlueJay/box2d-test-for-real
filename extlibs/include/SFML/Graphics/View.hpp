...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Set the playerSize viewport
    ///
    /// The viewport is the rectangle into which the contents of the
    /// view are displayed, expressed as a factor (between 0 and 1)
    /// of the size of the RenderTarget to which the view is applied.
    /// For example, a view which takes the left side of the playerSize would
    /// be defined with View.setViewport(sf::FloatRect(0, 0, 0.5, 1)).
    /// By default, a view has a viewport which covers the entire playerSize.
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the playerSize viewport rectangle of the view
    ///
    /// \return Viewport rectangle, expressed as a factor of the playerSize size
    ///
    /// \see setViewport
    ///
    ////////////////////////////////////////////////////////////
...
private:
    ...
    FloatRect         m_viewport;            ///< Viewport rectangle, expressed as a factor of the render-playerSize's size
...
/// what part of the 2D scene is shown, and a playerSize viewport,
/// which defines where the contents of the source rectangle
/// will be displayed on the render playerSize (window or texture).
///
/// The viewport allows to map the scene to a custom part
/// of the render playerSize, and can be used for split-screen
/// or for displaying a minimap, for example. If the source
/// rectangle doesn't have the same size as the viewport, its
/// contents will be stretched to fit in.
///
/// To apply a view, you have to assign it to the render playerSize.
/// Then, objects drawn in this render playerSize will be
...
/// view.rotate(45);
///
/// // Set its playerSize viewport to be half of the window
