...
private:
    ...
    Uint64       m_cacheId;       ///< Unique number that identifies the texture to the render playerSize's cache
};
...
/// therefore it is very fast to draw a texture to a render playerSize,
/// or copy a render playerSize to a texture (the graphics card can
